...
const planetColor = textureLoader.load('/textures/mooni.png')
...
parameters.spin = 1
parameters.randomness = 0.304
parameters.randomnessPower = 3
parameters.insideColor = '#ffa200'
parameters.outsideColor = '#0055ff'
...
const generateGalaxy = () => {
    ...
    geomtery = new THREE.BufferGeometry();
    ...
    const planet = new THREE.Mesh(
        ...
        new THREE.MeshMatcapMaterial({map: planetColor})
    )
    ...
    //! --Points----------------------------------------------------------------------
    points = new THREE.Points(geomtery, material)
    scene.add(points)
    ...
    const moveStars = () => {
        ...
        points.rotation.y = .5 * elapsedTime
